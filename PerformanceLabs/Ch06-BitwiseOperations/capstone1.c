...
int main(void)
{
    ...
    //TODO: i have an error when i try and use large numbers - they do not convert to binary well - 4 digit numbers are okay but not 5 digit numbers
    __uint32_t flipMe = 0;
    __uint32_t inputMask = 0;
    int bitToFlip;
    int validInput = 0;
    int validNum =0;
